...
public class JokeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://udacityGradleFinalProject.appspot.com/_ah/api/";
  ...
  public class Getjoke extends JokeApiRequest<com.udacity.gradle.builditbigger.backend.jokeApi.model.JokeBean> {
     ...
     */
    protected Getjoke() {
      super(JokeApi.this, "GET", REST_PATH, null, com.udacity.gradle.builditbigger.backend.jokeApi.model.JokeBean.class);
    }
